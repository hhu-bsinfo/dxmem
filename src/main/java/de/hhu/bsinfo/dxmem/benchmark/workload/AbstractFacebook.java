...
/**
 * Base workload for all facebook type benchmarks
 *
 * @author Stefan Nothaas, stefan.nothaas@hhu.de, 31.08.2018
 */
public abstract class AbstractFacebook extends AbstractWorkload {
     ...
     */
    AbstractFacebook(final String p_name, final int p_batchCount, final int p_objectSize, final float p_probGet,
