...
/**
 * Implementation of a chunk based on a ByteBuffer
 *
 * @author Stefan Nothaas, stefan.nothaas@hhu.de, 31.03.2017
 */
public final class ChunkByteBuffer extends AbstractChunk {
     ...
     */
    public ChunkByteBuffer(final int p_bufferSize) {
        super();
     ...
     */
    public ChunkByteBuffer(final long p_id, final int p_bufferSize) {
        super(p_id);
        m_data = ByteBuffer.allocate(p_bufferSize);
    }
     ...
     */
    public ChunkByteBuffer(final ByteBuffer p_buffer) {
        super();
     ...
     *         with shared references of the ByteBuffer object.
     */
    public ChunkByteBuffer(final long p_id, final ByteBuffer p_buffer) {
        super(p_id);
    ...
    public String toString() {
        return "ChunkByteBuffer[" + ChunkID.toHexString(getID()) + ", " + getState() + ", " + m_data.capacity() + ']';
    }
    ...
    public boolean equals(final Object p_other) {
        if (p_other instanceof ChunkByteBuffer) {
            ChunkByteBuffer other = (ChunkByteBuffer) p_other;

            return Arrays.equals(m_data.array(), other.m_data.array());
        } else {
            return false;
        }
    }
