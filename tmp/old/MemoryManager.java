...
import de.hhu.bsinfo.dxmem.core.StorageUnsafeMemory;
...
import static de.hhu.bsinfo.dxmem.core.CIDTableChunkEntry.ADDRESS;
...
public class MemoryManager {
    ...
    SmallObjectHeapDataStructureImExporter getImExporter(final long p_address) {
        ...
        if (importer == null) {
            m_imexporter[(int) tid] = new SmallObjectHeapDataStructureImExporter(heap, p_address, 0);
    ...
    public static class MemoryInformation {
        ...
        private final Heap m_rawMemory;
        ...
        MemoryInformation(MemoryManager memoryManager) {
            this.m_rawMemory = memoryManager.heap;
        ...
        public boolean exists(final long p_chunkID) {
            ...
            return address > Heap.INVALID_ADDRESS &&
                    address < m_rawMemory.m_baseFreeBlockList- Heap.SIZE_MARKER_BYTE;
        }
